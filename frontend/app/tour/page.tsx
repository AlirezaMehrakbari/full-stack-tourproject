    ...
    return (
        <div className='flex flex-col'>
            ...
            <div className='mx-auto mt-[-30px]'>
                <Layout>
                    <form onSubmit={handleSearch} className='xl:w-[1020px] grid xl:grid-cols-5 md:grid-cols-2 gap-8'>
                    ...
                    >
                        <div
                            ...
                            <ul className='flex flex-col gap-y-2'>
                                <li onClick={() => handleSortChange('')} className='cursor-pointer'>پیـشــنهاد مــا</li>
                                <li onClick={() => handleSortChange('newest')} className='cursor-pointer'>به روز
                                    تریــن
                                </li>
                                <li onClick={() => handleSortChange('cheapest')} className='cursor-pointer'>ارزانترین
                                </li>
                                <li onClick={() => handleSortChange('expensive')} className='cursor-pointer'>گران ترین
                                </li>
            ...
            <section className='w-[70%] mx-auto mt-[6rem] flex flex-col gap-y-4'>
